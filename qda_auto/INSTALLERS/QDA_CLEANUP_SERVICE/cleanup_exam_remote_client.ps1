...
function Clear-RecycleBin-Safe {
    Write-Line ""
    Write-Line "=========================================="
    Write-Line "        EMPTY RECYCLE BIN"
    Write-Line "=========================================="

    try {
        Clear-RecycleBin -Force -ErrorAction Stop
        Write-Line "[OK] Clear-RecycleBin thanh cong."
    }
    catch {
        Write-Line "[WARN] Clear-RecycleBin loi:"
        ...
        try {
            ...
            Write-Line "[OK] Fallback Recycle Bin cleanup completed."
        }
        catch {
            Write-Line "[FAIL] Fallback Recycle Bin cleanup failed."
            Write-Line "       $($_.Exception.Message)"
        }
    }
}
